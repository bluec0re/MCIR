...
$create_table_users = "CREATE TABLE IF NOT EXISTS challenge2_users (
			...
			username VARCHAR(32),
			password VARCHAR(64));";
$query_create_table = mysqli_query($GLOBALS["___mysqli_ston"], $create_table_users);
...
$query_create_table_articles = mysqli_query($GLOBALS["___mysqli_ston"], $create_table_articles);


$insert_test_users = "INSERT INTO challenge2_users (id, username, password)
			VALUES(1, 'admin', '$admin_password'),
			      (2, 'guest', '$guest_password')";
$query_insert_data = mysqli_query($GLOBALS["___mysqli_ston"], $insert_test_users);
...
mysqli_query($GLOBALS["___mysqli_ston"], $insert_test_articles);
