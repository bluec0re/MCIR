...
if(isset($_POST['username']) && isset($_POST['password']) && isset($_POST['email'])){
	...
	if(mysqli_num_rows($query_check_user) > 0)
		...
		$query_insert_user = mysqli_query($GLOBALS["___mysqli_ston"], $sql_insert_user) or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
